...
<div class="modal fade" tabindex="-1" role="dialog" id="basket">
    <div class="modal-dialog" role="document">
        <button type="button" class="close hidden-sm hidden-md hidden-lg" data-dismiss="modal" aria-label="Close"><img
                            ...
                            <div class="form-group-2">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <input class="" type="text" name="basket_pers_desktop" id="basket_pers_desktop"
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <p class="xs-orange xs-flex">Вы заработали: <span><span class="cnt-bonus">122</span> балла.</span></p>

...
<section class="fd__special__menu__area bg-image--3 section-pt--lg section-pt--xs">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="food__nav nav nav-tabs" role="tablist">
                            <a class="active mt-2" id="nav-all-tab" data-toggle="tab" href="#nav-all" role="tab" aria-selected="true">Все товары</a>
                            @foreach($restoran->categories->all() as $cat)
                                <a class="mt-2" id="nav-{{$cat->alias}}-tab" data-toggle="tab" href="#nav-{{$cat->alias}}" role="tab" aria-selected="false">{{$cat->name}}</a>
                            @endforeach

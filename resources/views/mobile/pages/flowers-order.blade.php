...
@section('content')
    ...
    <a href="/m/restoran/ona_hochet_dn" target="_blank" style="display: block" title="Цветочная лавка" >
        <img src="/images/fastoran/restorans/flowers.jpg" alt="Цветы Fastoran" class="img-fluid">
    </a>
    <a href="/m/restoran/ona_hochet_dn" target="_blank" class="mb-2 btn btn-outline-success w-100" title="Цветочная лавка" >
       Цветочная лавка
    </a>

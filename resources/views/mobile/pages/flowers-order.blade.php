...
@section('content')
    ...
    <a href="/m/restoran/ona_hochet_dn" class="mb-1" style="display: block" title="Цветочная лавка" aria-label="Цветочная лавка">
        <img src="/images/fastoran/restorans/flowers.jpg" alt="Цветы Fastoran" class="img-fluid">
    </a>
    <a href="/m/restoran/ona_hochet_dn" class="mb-2 btn btn-outline-info" style="display: block" title="Цветочная лавка" aria-label="Цветочная лавка">
       Цветочная лавка
    </a>

        ...
        <nav class="sidebar">
            ...
            <div class="sidebarGroup">
                <ul class="sidebarMenu upperSidebar">
                    ...
                    <li>
                        <a href="/m/likes" title="Мне понравлось" aria-label="Мне понравилось">
                            <i class="far fa-thumbs-up mr-1"></i>
                            Мне понравилось <mobile-likes-counter></mobile-likes-counter>
                        </a>
                    </li>
                    <li>
            ...
            <div class="sidebarGroup">
                <ul class="sidebarMenu">
                    ...
                    <li>
                        <a href="https://vk.com/fastorancom" rel="noreferrer" target="_blank" title="Fastoran в ВК"
                           aria-label="Fastoran в ВК">
                    ...
                    <li>
                        <a href="https://www.instagram.com/fastoran_dn/" rel="noreferrer" target="_blank"
                           title="Instagram Fastoran" aria-label="Instagram Fastoran">
            ...
            <div class="sidebarGroup">
                <ul class="sidebarMenu">
                    ...
                    <li>
                        <a href="https://t.me/diner_dn_bot" target="_blank" rel="noreferrer" title="Ресторан 'Diner'"
                           aria-label="Ресторан 'Diner'">
                            <img v-lazy="'/images/fastoran/diner-bot.jpg'" alt="diner_dn_bot" class="avatar">
                            Ресторан "Diner"
                        </a>
                    </li>
                    <li>
                        <a href="https://t.me/isushibot" target="_blank" rel="noreferrer" title="Ресторан 'Isushi'"
                           aria-label="Ресторан 'Isushi'">
                            <img v-lazy="'/images/fastoran/isushi-bot.jpg'" alt="isushibot" class="avatar">
                            Ресторан "Isushi"
                        </a>
                    </li>
                    <li>
                        <a href="https://t.me/svinya_dn_bot" target="_blank" rel="noreferrer" title="Гастропаб 'Свинья'"
                           aria-label="Гастропаб 'Свинья'">
                    ...
                    <li>
                        <a href="https://t.me/arkadia_donetsk_bot" target="_blank" rel="noreferrer"
                           title="Ресторан 'Аркадия'" aria-label="Ресторан 'Аркадия'">
                            <img v-lazy="'/images/fastoran/arcadia-bot.jpg'" alt="arkadia_donetsk_bot" class="avatar">
                            Ресторан "Аркадия"
                        </a>
                    </li>
                    <li>
                        <a href="https://t.me/pirogi_dn_bot" target="_blank" rel="noreferrer" title="Осетинские пироги"
                           aria-label="Осетинские пироги">

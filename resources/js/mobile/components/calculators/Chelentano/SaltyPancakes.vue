<template>
    <div>
        <h4 class="text-center mt-2">Блинчики соленые</h4>
        ...
        <div class="row d-flex justify-content-center result">
            <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                <h6 class="text-center">Сколько таких блинчиков сделать?</h6>
                <div class="summary">
                ...
                <p class="text-center" v-if="message.length>0"><mark class="text-white">{{message}}</mark></p>

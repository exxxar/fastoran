<template>
    <div>
        <h4 class="text-center mt-2">Собираем вкусные гонконгские вафли</h4>

        <h6 class="text-center">
            <mark>Выбираем основу</mark>
        </h6>
        <div class="row mt-2 mb-2 hot-dog-calc">


            <div class="col-12" v-for="fill in getFilling(15)">
                <div class="container-wrapper">
                    <label class="container">

                        <h6>{{fill.title}}  <span
                            class="badge badge-weight">{{fill.weight}} гр.</span><span
                            class="badge">{{fill.price | currency}}</span></h6>
        ...
        <div class="row d-flex justify-content-center result">
            <div class="col-12 col-sm-12 col-md-6 col-lg-4">
                <h6 class="text-center">Сколько таких вафель сделать?</h6>
                <div class="summary">
